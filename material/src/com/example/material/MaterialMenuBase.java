...
import static com.example.material.MaterialMenuDrawable.*;
...
public abstract class MaterialMenuBase implements MaterialMenu {
    ...
    /**
     * Overwrites behaviour of pressed state circle animation even when using {@link #animatePressedState(com.example.material.MaterialMenuDrawable.IconState)}
     *
