...
import static com.example.material.MaterialMenuDrawable.IconState;
...
public interface MaterialMenu {
    ...
    /**
     * Manually set a transformation value for an {@link com.example.material.MaterialMenuDrawable.AnimationState}
     *
     * @param animationState state to set value in
     * @param value          between {@link com.example.material.MaterialMenuDrawable#TRANSFORMATION_START} and
     *                       {@link com.example.material.MaterialMenuDrawable#TRANSFORMATION_END}.
     */
